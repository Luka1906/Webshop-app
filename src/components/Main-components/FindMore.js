...
return (
  ...
  <div className=" relative shadow-image-shadow bg-rakija-pic bg-cover bg-center bg-no-repeat h-[30rem] md:h-[40rem] md:w-2/3 m-auto flex flex-col justify-center items-center">
    ...
    <button className="drop-shadow-2xl scale-90 md:scale-100 bg-white p-1 px-3 font-[600] hover:bg-primary-color-red hover:text-white transition ease-in-out duration-200 active:scale-110 ">Learn more</button>
    <Link to="products"><button className=" drop-shadow-2xl  scale-90 md:scale-100 text-white p-1 px-3 font-[600] bg-primary-color-red hover:bg-white hover:text-text-color transition ease-in-out duration-200 active:scale-110 ">Shop now</button></Link>
  </div>
  </div>
  </div>
)
