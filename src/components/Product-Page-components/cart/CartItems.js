        ...
        <div className=" w-[90%] h-[10rem] flex text-[0.8rem] md:text-[0.85rem] p-4 bg-white items-start relative top-8 mb-3">
          ...
          <div className="flex flex-col px-2  md:px-3 justify-between h-[6.5rem]">
            ...
            <div className="flex items-start gap-3 ">
              <div className="flex absolute md:static left-[30px] gap-2">
                <button
                  onClick={onRemove}
              ...
              <div className="absolute md:static right-[5.5rem]  font-semi-bold-lato">
                ${sumPerItem.toFixed(2)}
              </div>

              <BsTrash
                onClick={onRemoveAll}
                className="absolute right-4 text-[0.9rem] cursor-pointer text-red-700"
              />
            </div>
          </div>
        </div>
